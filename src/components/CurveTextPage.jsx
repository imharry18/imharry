      ...
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full px-4 sm:px-6 relative">
            <WobbleCard
              ...
              onClick={() => window.open("https://github.com/imharry18", "_blank")}
            >
            ...
            <WobbleCard
              containerClassName=" cursor-pointer col-span-1 min-h-[300px] relative"
              onClick={() => window.open("https://leetcode.com/u/iharish18/", "_blank")}
            >
            ...
            <WobbleCard
              containerClassName=" cursor-pointer col-span-1 lg:col-span-3 bg-blue-900 min-h-[500px] lg:min-h-[600px] xl:min-h-[300px] relative"
              onClick={() => window.open("https://codolio.com/profile/imharry", "_blank")}
            >
