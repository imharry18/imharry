  ...
  return (
    ...
    <div className="text-center md:text-left">
      ...
      <p className="mt-4 max-w-md mx-auto md:mx-0 text-base text-gray-200 md:text-lg">
        Hi, I'm <strong>Harish Chouhan</strong>. I'm passionate about web development, UI engineering, and creative coding.
        <br />
        I love transforming ideas into intuitive digital experiences.
      </p>
      <p className="mt-2 max-w-md mx-auto md:mx-0 text-base text-gray-200">
        My skills include ReactJS, Next.js, TypeScript, Framer Motion, and Tailwind CSS.
      </p>
      <button
